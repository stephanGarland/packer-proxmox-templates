...
call_dialog() {
    ...
    dialog_values=$(dialog \
            ...
            --form "Template Options" 15 50 0 \
                "Role: "     1 1 "$vm_role"     1 10 10 0 \
                "CPU Type: " 2 1 "$vm_cpu_type" 2 10 10 0 \
                "Sockets: "  3 1 "$vm_sockets"  3 10 10 0 \
                "Cores: "    4 1 "$vm_cores"    4 10 10 0 \
                "Memory: "   5 1 "$vm_mem"      5 10 10 0 \
                "Disk: "     6 1 "$vm_disk"     6 10 10 0 \
                "ZFS: "      7 1 "$vm_zfs"      7 10 10 0 \
                "ZFS: "      8 1 "$vm_zsh"      8 10 10 0 \
                "VM ID: "    9 1 "$vm_id"       9 10 10 0 \
            --and-widget --insecure \
            --title "Create A New Template" \
